package co.github.androidutils.logger;
...
public class StartupLogWriter implements Logger.LogWriter {
    ...
    @Override
    public void write(Logger.LogLevel level, String tag, String message) {
        write(level, tag, message, null);
    }

    @Override
    public void write(Logger.LogLevel level, String tag, String message, Throwable throwable) {
