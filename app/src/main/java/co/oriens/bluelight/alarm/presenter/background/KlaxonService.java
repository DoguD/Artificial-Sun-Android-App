    ...
    private void initializePlayer(Uri alert) {
        ...
        try {
            ...
            if (mTelephonyManager.getCallState() != TelephonyManager.CALL_STATE_IDLE) {
                ...
                setDataSourceFromResource(getResources(), mMediaPlayer, co.oriens.bluelight.R.raw.in_call_alarm);
            } else {
            ...
            try {
                ...
                mMediaPlayer.reset();
                setDataSourceFromResource(getResources(), mMediaPlayer, co.oriens.bluelight.R.raw.fallbackring);
                startAlarm(mMediaPlayer);
            } catch (Exception ex2) {
