...
public class DigitalClock extends LinearLayout {
    ...
    static class AmPm {
        ...
        AmPm(View parent) {
            mAmPm = (AndroidClockTextView) parent.findViewById(co.oriens.bluelight.R.id.digital_clock_am_pm);
    ...
    protected void onFinishInflate() {
        ...
        mTimeDisplay = (AndroidClockTextView) findViewById(co.oriens.bluelight.R.id.digital_clock_time);
        mAmPm = new AmPm(this);
        mCalendar = Calendar.getInstance();
