...
import co.oriens.bluelight.alarm.view.VolumePreference.SeekBarVolumizer;
...
public class VolumePreference extends DialogPreference implements View.OnKeyListener, IVolumizerMaster {
    ...
    public VolumePreference(Context context, AttributeSet attrs) {
        ...
        setDialogLayoutResource(co.oriens.bluelight.R.layout.seekbar_dialog);

        // Steal the XML dialogIcon attribute's value
        mMyIcon = getDialogIcon();
        setDialogIcon(null);
        volumizers = new ArrayList<SeekBarVolumizer>();
    ...
    protected void onBindDialogView(View view) {
        ...
        final ImageView iconView = (ImageView) view.findViewById(co.oriens.bluelight.R.id.seekbar_dialog_icon);
        if (mMyIcon != null) {
        ...
        final SeekBar seekBar = (SeekBar) view.findViewById(co.oriens.bluelight.R.id.seekbar_dialog_seekbar_master_volume);
        ...
        final SeekBar alarmSeekBar = (SeekBar) view.findViewById(co.oriens.bluelight.R.id.seekbar_dialog_seekbar_alarm_volume);
        volumizers.add(new SeekBarVolumizer(alarmSeekBar, new AlarmVolumizerStrategy(getContext()), this));

        final SeekBar preAlarmSeekBar = (SeekBar) view.findViewById(co.oriens.bluelight.R.id.seekbar_dialog_seekbar_prealarm_volume);
    ...
    private void cleanup() {
        ...
        if (dialog != null && dialog.isShowing()) {
            View view = dialog.getWindow().getDecorView().findViewById(co.oriens.bluelight.R.id.seekbar_dialog_seekbar_master_volume);
            if (view != null) {
    ...
    private void createActionButtons(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, co.oriens.bluelight.R.styleable.com_better_alarm_view_VolumePreference, 0, 0);
        boolean cancelButtonUsed = a.getBoolean(co.oriens.bluelight.R.styleable.com_better_alarm_view_VolumePreference_cancelButton, true);
