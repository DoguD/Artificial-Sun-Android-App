...
public class TimePicker extends TimerSetupView implements Button.OnClickListener {
    ...
    public TimePicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        mInputSize = 4;
        mNoAmPmLabel = context.getResources().getString(co.oriens.bluelight.R.string.time_picker_ampm_label);
    }

    @Override
    protected int getLayoutId() {
        return co.oriens.bluelight.R.layout.time_picker_view;
    }
    ...
    protected void onFinishInflate() {
        ...
        if (mIs24HoursMode) {
            mLeft.setText(res.getString(co.oriens.bluelight.R.string.time_picker_00_label));
            mRight.setText(res.getString(co.oriens.bluelight.R.string.time_picker_30_label));
        } else {
        ...
        mAmPmLabel = (TextView) findViewById(co.oriens.bluelight.R.id.ampm_label);
