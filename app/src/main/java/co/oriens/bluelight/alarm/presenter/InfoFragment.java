package co.oriens.bluelight.alarm.presenter;
...
public class InfoFragment extends Fragment implements ViewFactory {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(co.oriens.bluelight.R.layout.info_fragment, container, false);
        textView = (TextSwitcher) view.findViewById(co.oriens.bluelight.R.id.info_fragment_text_view);
        remainingTime = (TextSwitcher) view.findViewById(co.oriens.bluelight.R.id.info_fragment_text_view_remaining_time);
    ...
    private String formatRemainingTimeString(long timeInMillis) {
        ...
        String daySeq = days == 0 ? "" : days == 1 ? getActivity().getString(co.oriens.bluelight.R.string.day) : getActivity().getString(
                co.oriens.bluelight.R.string.days, Long.toString(days));

        String minSeq = minutes == 0 ? "" : minutes == 1 ? getActivity().getString(co.oriens.bluelight.R.string.minute) : getActivity()
                .getString(co.oriens.bluelight.R.string.minutes, Long.toString(minutes));

        String hourSeq = hours == 0 ? "" : hours == 1 ? getActivity().getString(co.oriens.bluelight.R.string.hour) : getActivity()
                .getString(co.oriens.bluelight.R.string.hours, Long.toString(hours));
        ...
        String[] formats = getActivity().getResources().getStringArray(co.oriens.bluelight.R.array.alarm_set_short);
    ...
    private void formatString() {
        if (isPrealarm) {
            ...
            remainingTime.setText(formatRemainingTimeString(milliseconds) + "\n"
                    + getResources().getString(co.oriens.bluelight.R.string.info_fragment_prealarm_summary, duration));
        } else {
            remainingTime.setText(formatRemainingTimeString(milliseconds));
        }
    }
    ...
    public View makeView() {
        TextView t = (TextView) getActivity().getLayoutInflater().inflate(co.oriens.bluelight.R.layout.info_fragment_text, null);
        return t;
    }
}