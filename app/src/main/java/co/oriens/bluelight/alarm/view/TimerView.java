...
public class TimerView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mHoursTens = (TextView) findViewById(co.oriens.bluelight.R.id.hours_tens);
        mMinutesTens = (TextView) findViewById(co.oriens.bluelight.R.id.minutes_tens);
        mHoursOnes = (TextView) findViewById(co.oriens.bluelight.R.id.hours_ones);
        mMinutesOnes = (TextView) findViewById(co.oriens.bluelight.R.id.minutes_ones);
    }
