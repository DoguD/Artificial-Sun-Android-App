...
package co.oriens.bluelight.alarm.model;
...
import co.github.androidutils.statemachine.ComplexTransition;
import co.github.androidutils.statemachine.IMessageWhatToStringConverter;
import co.github.androidutils.statemachine.IOnStateChangedListener;
import co.github.androidutils.statemachine.IState;
import co.github.androidutils.statemachine.State;
import co.github.androidutils.statemachine.StateMachine;
import co.oriens.bluelight.alarm.model.interfaces.Alarm;
import co.oriens.bluelight.alarm.model.interfaces.AlarmEditor;
...
public final class AlarmCore implements Alarm {
    ...
    private class AlarmStateMachine extends StateMachine {
        ...
        private class DisabledState extends AlarmState {
            @Override
            protected void onChange(AlarmEditor.AlarmChangeData changeData) {
        ...
        private void writeChangeData(AlarmEditor.AlarmChangeData data) {
        ...
        private boolean alarmWillBeRescheduled(Message reason) {
            boolean alarmWillBeRescheduled = reason.what == CHANGE && ((AlarmEditor.AlarmChangeData) reason.obj).enabled;
        ...
        private class AlarmState extends State {
            ...
            public final boolean processMessage(Message msg) {
                ...
                case DISMISS:
                    ...
                    break;
                case CHANGE:
                    onChange((AlarmEditor.AlarmChangeData) msg.obj);
                    break;
                case FIRED:
                    onFired();
                    break;
    ...
    public void change(AlarmEditor.AlarmChangeData data) {
    ...
    public String getLabelOrDefault(Context context) {
        if (container.getLabel() == null || container.getLabel().length() == 0)
            return context.getString(co.oriens.bluelight.R.string.default_label);
        return container.getLabel();
    }
