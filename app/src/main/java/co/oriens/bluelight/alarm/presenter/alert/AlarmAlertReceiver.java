...
package co.oriens.bluelight.alarm.presenter.alert;
...
import co.oriens.bluelight.alarm.model.AlarmsManager;
import co.oriens.bluelight.alarm.model.interfaces.Alarm;
import co.oriens.bluelight.alarm.model.interfaces.AlarmNotFoundException;
import co.oriens.bluelight.alarm.model.interfaces.IAlarmsManager;
import co.oriens.bluelight.alarm.model.interfaces.Intents;
import co.oriens.bluelight.alarm.model.interfaces.PresentationToModelIntents;
import co.oriens.bluelight.alarm.presenter.TransparentActivity;
...
public class AlarmAlertReceiver extends BroadcastReceiver {
    ...
    private void onAlert(Alarm alarm) {
        ...
        Notification status = new NotificationCompat.Builder(mContext)
                ...
                .setContentText(mContext.getString(co.oriens.bluelight.R.string.alarm_notify_text))
                .setSmallIcon(co.oriens.bluelight.R.drawable.stat_notify_alarm)
                ...
                .setOngoing(true)
                .addAction(co.oriens.bluelight.R.drawable.ic_action_snooze, mContext.getString(co.oriens.bluelight.R.string.alarm_alert_snooze_text), pendingSnooze)
                .addAction(co.oriens.bluelight.R.drawable.ic_action_reschedule_snooze, mContext.getString(co.oriens.bluelight.R.string.alarm_alert_reschedule_text), pendingReschedule)
                .addAction(co.oriens.bluelight.R.drawable.ic_action_dismiss, mContext.getString(co.oriens.bluelight.R.string.alarm_alert_dismiss_text), pendingDismiss)
    ...
    private void onSnoozed(int id) {
        ...
        Notification status = new NotificationCompat.Builder(mContext)
                ...
                .setContentTitle(mContext.getString(co.oriens.bluelight.R.string.alarm_notify_snooze_label, label))
                .setContentText(mContext.getString(co.oriens.bluelight.R.string.alarm_notify_snooze_text, formatTimeString()))
                .setSmallIcon(co.oriens.bluelight.R.drawable.stat_notify_alarm)
    ...
    private void onSoundExpired(int id) {
        ...
        int autoSilenceMinutes = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(mContext).getString(
                "auto_silence", "10"));
        String text = mContext.getString(co.oriens.bluelight.R.string.alarm_alert_alert_silenced, autoSilenceMinutes);

        Notification.Builder nb = new Notification.Builder(mContext);
        nb.setAutoCancel(true);
        nb.setSmallIcon(co.oriens.bluelight.R.drawable.stat_notify_alarm);
